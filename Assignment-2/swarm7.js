...
const numGroups = 3; // Number of swarms and targets
...
function drawLinesBetweenEntities() {
  let maxDistance = 100; // Maximum distance to draw line
  let minDistance = 1;  // Minimum distance for maximum line intensity
